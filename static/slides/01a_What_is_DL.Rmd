---
title: "AI, Machine Learning, Deep Learning concepts"
subtitle: "Achievements and current limitations"
...
- **Feature selection** - selecting features most important for accurate classification. Automated by Deep Learning
...
- Popular in computer vision ( [VGG-16](https://neurohive.io/en/popular-networks/vgg16/), [ResNet](https://builtin.com/artificial-intelligence/resnet-architecture) ), NLP ([ChatGPT](https://openai.com/chatgpt/), [BERT](https://towardsdatascience.com/bert-explained-state-of-the-art-language-model-for-nlp-f8b21a9b6270))
...
.center[<img src="img/layers.png" height=400>]
