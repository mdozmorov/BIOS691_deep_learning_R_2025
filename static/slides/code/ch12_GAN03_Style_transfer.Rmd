...
Auxiliary functions for loading, preprocessing, and postprocessing the images 
that go in and out of the VGG19 convnet.
...
The loss being minimized is a **weighted average of content loss, style loss (across multiple layers), and total variation loss**. 
